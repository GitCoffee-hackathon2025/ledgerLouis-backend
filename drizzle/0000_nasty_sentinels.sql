...
CREATE TYPE "public"."permission_role" AS ENUM('owner', 'admin', 'viewer');--> statement-breakpoint
...
ALTER TABLE "verification_email" ADD CONSTRAINT "verification_email_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_accounts_company_value" ON "accounts" USING btree ("company_id","value");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_token_verification_email" ON "verification_email" USING btree ("token_hash");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_token_invites" ON "invites" USING btree ("token_hash");--> statement-breakpoint
